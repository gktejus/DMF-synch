...
def main(*, depth, hidden_sizes, n_iters, problem, train_thres, _seed, _log, _writer, _info, _fs):
    ...
    ground_truth = torch.from_numpy(scipy.io.loadmat(os.path.join("./MATLAB_SO3/datasets_cam500/", dataset+".mat"))['R_gt'].transpose(2,0,1))
    ncams = scipy.io.loadmat(os.path.join( "./MATLAB_SO3/datasets_cam500/", dataset+".mat"))['nviews'][0][0]
    method = "median"
